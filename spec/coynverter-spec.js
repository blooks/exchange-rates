...
describe("convert", function () {
  it("Should convert function return 0.100172 BTC to EUR for 2015-01-17 with a value of 17.2902481632", function (done) {
    ...
    coynverter.convert("meteor", "2015-01-17", "EUR", 0.100172, "bitcoinExchangeRates", function (err, amount) {
  ...
  it("Should convert function return 0.100172 BTC to USD for 2015-01-17 with a value of 19.9968355", function (done) {
    var coynverter = new Coynverter();
    coynverter.convert("meteor", "2015-01-17", "USD", 0.100172, "bitcoinExchangeRates", function (err, amount) {
...
// coynverter.getExchangeRatesForNewCurrency("meteor", "USD", "bitcoinExchangeRates", function (err, result) {
//   log.info(result);
// });